                ...
                <ul class="nofitications-dropdown">
                  ...
                  <li class="dropdown head-dpdn">
                    <a
                      ...
                      ><span class="badge blue1">9</span></a
                    >
                    <ul class="dropdown-menu">
                      <li>
                        <div class="notification_header">
          ...
          <div class="inner-block">
            ...
            <div class="market-updates row">
              <div class="col-md-4 market-update-gd">
                <div class="market-update-block clr-block-1 row">
              ...
              <div class="col-md-4 market-update-gd">
                <div class="market-update-block clr-block-2 row">
                  <div class="col-md-8 market-update-left">
                    <h3>135</h3>
              ...
              <div class="col-md-4 market-update-gd">
                <div class="market-update-block clr-block-3 row">
                  <div class="col-md-8 market-update-left">
                    <h3>23</h3>
                    <h4>New Messages</h4>
                    <p>Other hand, we denounce</p>
            ...
            <div class="climate row">
              <div class="col-md-4 climate-grids">
                <div class="climate-grid1">
                  <div class="climate-gd1-top row ml-0 mr-0">
                  ...
                  <div class="climate-gd1-bottom row">
